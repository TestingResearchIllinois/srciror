...
SRCIROR_COVINSTRUMENTATION_LIB=$CURR_DIR/../IRMutation/InstrumentationLib/SRCIRORCoverageLib.o SRCIROR_LLVMMutate_LIB=/scratch/hariri2/c-optimute/experiment/tools/llvm-build/Release+Asserts/lib/LLVMMutate.so SRCIROR_LLVM_BIN=/scratch/hariri2/c-optimute/experiment/tools/llvm-build/Release+Asserts/bin/ python $CURR_DIR/../IRMutation/PythonWrappers/irCoverageClang test.c -o test
